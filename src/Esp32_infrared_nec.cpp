...
{
    if ((item->level0 == RMT_RX_ACTIVE_LEVEL && item->level1 != RMT_RX_ACTIVE_LEVEL) && check_in_range(item->duration0, NEC_HEADER_HIGH_US, NEC_BIT_MARGIN) && check_in_range(item->duration1, NEC_HEADER_LOW_US, NEC_BIT_MARGIN))
    {
        return true;
    }
    return false;
...
{
    if ((item->level0 == RMT_RX_ACTIVE_LEVEL && item->level1 != RMT_RX_ACTIVE_LEVEL) && check_in_range(item->duration0, NEC_BIT_ONE_HIGH_US, NEC_BIT_MARGIN) && check_in_range(item->duration1, NEC_BIT_ONE_LOW_US, NEC_BIT_MARGIN))
    {
        return true;
    }
    return false;
...
{
    if ((item->level0 == RMT_RX_ACTIVE_LEVEL && item->level1 != RMT_RX_ACTIVE_LEVEL) && check_in_range(item->duration0, NEC_BIT_ZERO_HIGH_US, NEC_BIT_MARGIN) && check_in_range(item->duration1, NEC_BIT_ZERO_LOW_US, NEC_BIT_MARGIN))
    {
        return true;
    }
    return false;
