...
class Ir_YS_IRTM : public HardwareSerial{
  public:
    Ir_YS_IRTM  (uint8_t hardware_serial_nr, uint16_t baud_rate=9600);   // 2 for rx_pin=16, tx_pin=17
    void        send_ir(uint8_t data[3]), //not tested
                ...
                set_baud_rate(uint16_t baud_rate); //allowed values: 4800, 9600, 19200, 57600
    uint16_t    get_baud_rate();
